      ...
      <div  class=" col-lg-6 row g-3" style={{fontSize:'12px', marginTop:'14px'}}>
        <h4 >Espacios</h4>
            ...
            <div className="mx-auto" >
             ...
             <p>Contamos con una gran cantidad de mesas, rodeada de parrillas y canillas de agua, para que tengas las necesidades basicas a la hora de la comida</p>
            </div>
            <div className="mx-auto" >
            <img className="fotosCamping" src={espacioCampingDos} alt="" />
            <p>Hermoso quincho abierto, que funciona como el "patio" de la cantina para que te sientes a disfrutar de los servicios de la misma</p>
            </div>
            <div className="mx-auto" >
