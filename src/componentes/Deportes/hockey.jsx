...
function Hockey(){
    ...
    <img src={hockeyPort } className="portadaBs col-lg-12 " alt="portadaBas" />
    ...
    <div className="row">
      <div className="accordion contenedor col-lg-6" id="accordionExample">
               ...
               <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> 
                  ...
                  <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        ...
                        <h6>Dias: Miercoles-Viernes Sede:Pellegrini</h6> <p>Profesores: ------</p>
                          <ul className="list-group">
                          <li className="list-group-item"> <strong>Decima- Predecima</strong>: 18:00hs a 19:00hs </li>
                          <li className="list-group-item"> <strong>Novena</strong>: 19:00hs a 20:00hs </li>
                        </ul>
                      </div>
                  </div>
            </div>
            <div className="accordion-item ">
               <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> 
                  Inferiores Femenino Y Maxihockey
               </button>
                  <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <img src={logoNuevo} style={{height: '44px', width:'76px'}} className="mx-auto" alt="logo"/>
                        <h6>Dias: Lunes a Viernes  Sede:Camping</h6> <p>Profesores: ------</p>
                          <ul className="list-group">
                          <li className="list-group-item"> <strong>Sub 12- Octavas</strong>: 18:00hs a 19:00hs(LUNES-MIERCOLES-VIERNES)</li>
                          <li className="list-group-item"> <strong>Sub 14- Sub 16</strong>: 18:00hs a 20:00hs(LUNES-MARTES-JUEVES) </li>
                          <li className="list-group-item"> <strong>Sub 19- Mayores</strong>: 20:00hs a 22:30hs(MARTES-JUEVES-VIERNES) </li>
                          <li className="list-group-item"> <strong>Maxihockey</strong>: 20:30hs a 21:30hs(LUNES-MIERCOLES)</li>
                        </ul>
                      </div>
                  </div>
            </div>
