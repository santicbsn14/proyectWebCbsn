...
function Judo() {
  ...
  const ACC_ID = "accordion-judo";
  const collapseId = (i) => `judo-collapse-${i}`;
  const headingId  = (i) => `judo-heading-${i}`;
  ...
  return (
    <main className="mainSports" style={{ marginTop: "8rem" }}>
      <img src={judoPort} className="portadaBs col-lg-12" alt="portada-judo" />
