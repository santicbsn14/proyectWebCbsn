...
import taekwondoPort from '../imagenes/taekwondo_port.webp'
import './sports.css'
function Taekwondo(){
    return(
    <main className='mainSports' style={{marginTop:'8rem'}}>  
    <img src={taekwondoPort} className="portadaBs col-lg-12 " alt="portadaBas" />
                  ...
                  <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        ...
                        <h6>Dias: Lunes-Miercoles-Viernes  Sede:Pellegrini</h6> <p>Profesores: ------</p>
                          ...
                          <li className="list-group-item"> <strong>A partir de los 5 años</strong>: 18:30hs a 19:30hs </li>
                        </ul>
                      </div>
                  </div>
            </div>
